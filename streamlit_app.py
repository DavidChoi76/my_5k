...
datafile1 = "electric-vehicle-charging-stations.csv"
datafile2 = "local-area-boundary.geojson"
...
if selected == "구제사역팀":
    ...
    map1 = folium.Map(location=[36.9, 127.6], zoom_start=12)
    ...
    st.header("NCMN 5K운동 구제사역 현황(2025-02-12)", divider=True)
    ...
    link = "[CITY OF VANCOUVER OPEN DATA PORTAL - Electric vehicle charging stations]"
    ...
    map2 = folium.Map(location=[36.9, 127.6], zoom_start=12)
    ...
    # Show the data source
    link = "[CITY OF VANCOUVER OPEN DATA PORTAL - Local area boundary])"
    st.markdown("Data Source: " + link, unsafe_allow_html=True)
